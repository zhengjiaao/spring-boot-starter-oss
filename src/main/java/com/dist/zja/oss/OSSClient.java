...
import io.oss.*;
import io.oss.credentials.Credentials;
import io.oss.credentials.Provider;
import io.oss.credentials.StaticProvider;
import io.oss.errors.*;
import io.oss.http.Method;
import io.oss.messages.*;
import io.oss.org.apache.commons.validator.routines.InetAddressValidator;
import okhttp3.*;
 ...
 * }</pre>
 */
@ClassComment(value = "OSS 客户端", author = "zhengja")
public class OSSClient extends S3Base {
    private OSSClient(
            HttpUrl baseUrl,
            String region,
            boolean isAwsHost,
    ...
    protected OSSClient(OSSClient client) {
        super(client);
    }
